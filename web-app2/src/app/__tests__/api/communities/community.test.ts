import { isAdminUserId } from "@/lib/community.helper";
...
//   });
//
//   // Should handle large lists of participants efficiently
//   it("should handle large lists of participants efficiently", () => {
//     const participants = [];
//     for (let i = 0; i < 1000000; i++) {
//       participants.push({ user: `user${i}`, joined_at: new Date() });
//     }
//     const oldestMember = getTheOldestMember(participants);
//     expect(oldestMember).toBe("user0");
//   });
//
